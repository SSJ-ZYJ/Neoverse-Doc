...
Route transitions are coordinated by six files under `src/components/transition/`:
...
`src/styles/transitions.css` defines the transition visual rules.
...
| File | Responsibility |
| :--- | :--- |
| `src/components/transition/transition-types.ts` | type contracts |
| `src/components/transition/transition-policy.ts` | route-to-transition-semantics mapping |
| `src/components/transition/transition-controller.ts` | DOM cloning and geometry computation |
| `src/components/transition/transition-provider.tsx` | transition state and cleanup |
| `src/components/transition/transition-layer.tsx` | inert visual layer |
| `src/components/transition/transition-link.tsx` | next/link wrapper |
| `src/components/transition/back-link.tsx` | declarative back link |
| `src/components/transition/content-particle-transition.ts` | WebGL particle exit between docs |
| `src/styles/transitions.css` | transition visual rules |
| `src/lib/motion-config.ts` | transition durations and timeout config |