...
| `src/content/search/facets.ts` | Chapter compatibility plus taxonomy tags / future filters |
...
| `src/features/search/components/search-dialog.tsx` | Query and Chapter scope UI |
