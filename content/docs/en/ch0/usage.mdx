...
> This page introduces the site features most frequently used by ordinary readers: navigation and TOC, full-text search, theme and language, code blocks, alerts and collapsible content, task progress, Mermaid diagrams, page actions, and comments. There is a checklist of operations at the end of the page that you can try while reading.
...
If your operating system has "reduce motion" enabled, this site reduces non-essential motion. This setting does not affect the main content or core operations.
...
The component syntax, `Frontmatter`, and contribution workflow for documentation authors are out of scope for this page; continue with the [Syntax Examples](/en/docs/about/syntax-example) and the [Contribution Guide](/en/docs/about/guide).