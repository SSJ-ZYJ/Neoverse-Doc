...
> The commands in this section are bash-based (Linux / macOS / WSL / Git Bash). Windows CMD and PowerShell have different syntax and are out of scope for this section. It is recommended to practice with [WSL](/en/docs/ch1/1.14-Environment-Setup-WSL) or Git Bash.
