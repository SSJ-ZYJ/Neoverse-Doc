...
flowchart TD
    ...
    subgraph S5[Stage 5: Environment Setup]
        direction TB
        S5_1["1.14 WSL Environment Setup<br/>Building a Linux development environment"]
        S5_2["1.14 Windows Environment Setup<br/>Setting up with scoop"]
    end
...
| Section | Goal |
| :------------------------------------ | :------------------------------------------------ |
| [1.14 WSL Environment Setup](./ch1/1.14-Environment-Setup-WSL) | Install WSL and the Linux toolchain, configure VS Code Remote Development, SSH, and Docker |
| [1.14 Windows Environment Setup](./ch1/1.14-Environment-Setup-Windows) | Use scoop to install Git, Node.js, Python, and the MSYS2 C/C++ toolchain |
...
- [ ] Complete Stage 5: [WSL Environment Setup](./ch1/1.14-Environment-Setup-WSL) and [Windows Environment Setup](./ch1/1.14-Environment-Setup-Windows)
