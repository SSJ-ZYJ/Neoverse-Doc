...
| Section | Goal |
| :------------------------------------ | :------------------------------------------------ |
| [1.14 Environment Setup](./ch1/1.14-Environment-Setup) | Connect WSL, Git, Node.js, Python, VS Code, and Docker into a complete environment |
...
| [1.18 Kubernetes Basics](./ch1/1.18-Kubernetes-Basics) | Understand cluster architecture and orchestration concepts: Pod, Deployment, Service |
...
- [ ] Complete Stage 5: [Environment Setup](./ch1/1.14-Environment-Setup)
...
- [ ] Complete Stage 7: [Docker Basics](./ch1/1.17-Docker-Basics) and [Kubernetes Basics](./ch1/1.18-Kubernetes-Basics)
