...
After installing Git (see [1.14 Windows Environment Setup](/zh/docs/ch1/1.14-Environment-Setup-Windows) or [1.14 WSL Environment Setup](/zh/docs/ch1/1.14-Environment-Setup-WSL) for installation), the first thing is to configure your identity:
