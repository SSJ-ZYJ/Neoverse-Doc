...
The tutorial guides you through moving, deleting, inserting, undoing, and searching in an editable practice file. The content and the time required may vary between versions; it is recommended to practice through it once in full — it's a lot of fun 🙂.
...
## 6. Configure a Restrained `.vimrc`
...
## 7. Setting the Default Terminal Editor
