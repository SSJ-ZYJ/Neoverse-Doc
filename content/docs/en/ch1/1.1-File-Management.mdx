...
>
> For a drive with a total capacity `≤ 2TB`, two partitions (system and data) are enough. Too many partitions reduce space utilization and add management hassle.
>
...
| Manage versions with numbers | Use `v1`, `v2`, or dates | Don't pile up "final" and "really final" |
