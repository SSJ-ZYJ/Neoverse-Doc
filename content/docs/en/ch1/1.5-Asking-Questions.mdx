...
Why does this work? "Saying it out loud" and "thinking it in your head" are two different things: the brain easily "fills in" the parts it is unsure about, but when speaking, every line must be explicitly said, and any careless assumption gets exposed.
...
> The hardest part of hallucination to deal with: when it errs, it is often very confident, reading exactly like a correct answer.
>
