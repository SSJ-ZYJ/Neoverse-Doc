...
> [!INFO]
> This section mainly introduces software and tools that assist daily use; it does not cover development environment setup — for environment configuration, see [1.14 Windows Environment Setup](/zh/docs/ch1/1.14-Environment-Setup-Windows) or [1.14 WSL Environment Setup](/zh/docs/ch1/1.14-Environment-Setup-WSL).
>
...
- **VS Code**: a free, open-source code editor and the main tool for future development; installation steps are in [1.7 Text Editing](/en/docs/ch1/1.7-Text-Editing), and environment configuration is in [1.14 Windows Environment Setup](/zh/docs/ch1/1.14-Environment-Setup-Windows).
