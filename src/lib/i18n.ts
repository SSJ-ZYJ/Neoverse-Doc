...
//   1. source loader (`src/adapters/fumadocs/source.ts`) to bucket docs per language
//   2. fumadocs-ui translations (`src/adapters/fumadocs/layout.tsx`) via defineI18nUI
